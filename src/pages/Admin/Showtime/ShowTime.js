    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                notifiFunction('success', 'Tạo lịch chiếu phim thành công!', `${result.data.content}`)

            } catch (error) {
                console.log('error', error.response?.data)
                notifiFunction('error', 'Tạo lịch chiếu phim Unsuccess!', `${error.response?.data.content}`)
            }
        }
    })
